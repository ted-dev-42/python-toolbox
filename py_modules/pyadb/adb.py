...
class ADB():
    ...
    def get_version(self):
        ...
        try:
            if str(self.__output).startswith("Android Debug Bridge"):
                first_line = self.__output.splitlines()
                # ret = self.__output.split()[-1:][0]
                ret = first_line[0].split()[-1:][0]
    ...
    def set_adb_path(self, adb_path="adb"):
        """
    ...
    def reboot_device_mode(self, mode):
        """
